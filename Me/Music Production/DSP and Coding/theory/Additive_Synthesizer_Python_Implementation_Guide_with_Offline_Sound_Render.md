...
- Note that: `sounddevice` is used for **real-time audio output** and `soundfile` is used for **offline render to WAV first**.

---
# `oscillator.py`

Further Code Dissection - [[Additive_Synthesizers_Oscillator_Code_Dissection]]
